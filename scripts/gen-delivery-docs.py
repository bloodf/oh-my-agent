...
TASKS += [
    ...
    Task(
        ...
        files=["src/extension/index.ts", "src/extension/commands.ts", "src/extension/widget.ts", "src/extension/ensure-daemon.ts", "tests/extension.test.ts", "tests/ensure-daemon.test.ts"],
        assets=[
