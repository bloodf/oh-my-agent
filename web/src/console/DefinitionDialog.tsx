 ...
 * draft intact. The account spending ceiling is shown read-only and carried
        ...
        >
          ...
          <div className="flex min-h-0 min-w-0 flex-1 flex-col">
            <div className="min-h-0 flex-1 overflow-y-auto px-5 py-5 sm:px-7" aria-label={current?.label}>
              <div hidden={section !== "soul"} className="flex h-full min-h-[22rem] flex-col"><SoulSection {...props} /></div>
              ...
              {section === "wake" && <WakeSection {...props} budgetUsd={budgetUsd} />}
              {name && section === "schedules" && <SchedulesSection {...props} name={name} call={call} />}
              {section === "sandbox" && <SandboxSection {...props} />}
