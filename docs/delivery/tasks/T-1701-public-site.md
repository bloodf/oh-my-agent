...
| [`website/src/app/console/login/page.tsx`](../../../website/src/app/console/login/page.tsx) | New | The demo password screen. |
...
| [`website/src/components/demo/DemoBanner.tsx`](../../../website/src/components/demo/DemoBanner.tsx) | New | Demo notice with the password on login and reset and log out on the console. |
| [`website/src/components/demo/DemoGuard.tsx`](../../../website/src/components/demo/DemoGuard.tsx) | New | Redirects to the login page when the session token is not the demo password. |
| [`website/src/components/demo/DemoLogin.tsx`](../../../website/src/components/demo/DemoLogin.tsx) | New | AuthScreen markup with the same ids; refuses every other value. |
...
| [`website/src/mock/demoPassword.ts`](../../../website/src/mock/demoPassword.ts) | New | The one password the demo accepts. |
...
2. Mount the real console client-only behind a password screen; patch fetch, the events WebSocket, and the upload XHR; seed fixtures and persist state; answer every route in console-api.ts.
...
- [x] The demo refuses any password but the documented one and lands on the console shell with the seeded rooms.
...
| Claim | Anchor |
|---|---|
| Wrong password refused, melon accepted, every view and dialog driven in Chrome at 1440 and 390 wide with zero uncaught errors, on 2026-09-14 | [`website/src/components/demo/DemoLogin.tsx`](../../../website/src/components/demo/DemoLogin.tsx) |
...
| next build lists /, /console, /console/login, /console/review/[id]; tsc clean in website; root lint and typecheck clean with website excluded | [`website/package.json`](../../../website/package.json) |
