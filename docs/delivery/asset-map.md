...
| `src/daemon/runtime.ts` | yes | [T-502](tasks/T-502-daemon-entry-point.md) | — |
...
| `src/extension/ensure-daemon.ts` | yes | [T-504](tasks/T-504-tui-surface.md) | — |
