...
| `agents/example-researcher.md` | not yet | [T-501](tasks/T-501-peer-store.md) | — |
| `agents/example-reviewer.md` | not yet | [T-501](tasks/T-501-peer-store.md) | — |
...
| `src/daemon/db.ts` | not yet | [T-508](tasks/T-508-daemon-persistence.md) | — |
| `src/daemon/main.ts` | not yet | [T-502](tasks/T-502-daemon-entry-point.md), [T-508](tasks/T-508-daemon-persistence.md) | — |
...
| `src/shared/protocol-schemas.ts` | not yet | [T-507](tasks/T-507-control-socket-protocol.md) | — |
| `src/shared/protocol.ts` | not yet | [T-507](tasks/T-507-control-socket-protocol.md) | [T-502](tasks/T-502-daemon-entry-point.md), [T-503](tasks/T-503-agent-toolbelt.md), [T-504](tasks/T-504-tui-surface.md) |
...
| `tests/daemon-main.test.ts` | not yet | [T-502](tasks/T-502-daemon-entry-point.md) | — |
| `tests/daemon-persistence.test.ts` | not yet | [T-508](tasks/T-508-daemon-persistence.md) | — |
| `tests/end-to-end.test.ts` | yes | [T-405](tasks/T-405-supervisor.md) | — |
| `tests/extension.test.ts` | not yet | [T-504](tasks/T-504-tui-surface.md) | — |
...
| `tests/peer-store.test.ts` | not yet | [T-501](tasks/T-501-peer-store.md) | — |
| `tests/protocol.contract.test.ts` | not yet | [T-507](tasks/T-507-control-socket-protocol.md) | — |
...
| `tests/toolbelt.test.ts` | not yet | [T-503](tasks/T-503-agent-toolbelt.md), [T-604](tasks/T-604-reaction-toolbelt.md) | — |
