...
| `tests/daemon-console-mount.test.ts` | not yet | [T-1001](tasks/T-1001-console-mounted-at-boot.md) | — |
...
| `tests/usage-meter.test.ts` | not yet | [T-1002](tasks/T-1002-usage-feeds-the-meter.md) | — |
