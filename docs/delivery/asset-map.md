...
| `src/daemon/credential-gateway.ts` | yes | [T-301](tasks/T-301-credential-gateway.md), [T-302](tasks/T-302-shared-disable-recovery.md) | [T-004](tasks/T-004-broker-contract.md), [T-303](tasks/T-303-client-integration.md), [T-502](tasks/T-502-daemon-entry-point.md) |
...
| `src/daemon/peer-store.ts` | not yet | [T-501](tasks/T-501-peer-store.md), [T-505](tasks/T-505-definition-staleness.md) | — |
...
| `src/daemon/supervisor.ts` | yes | [T-405](tasks/T-405-supervisor.md), [T-505](tasks/T-505-definition-staleness.md), [T-506](tasks/T-506-metered-budget-wiring.md) | [T-502](tasks/T-502-daemon-entry-point.md) |
...
| `src/rooms/store.ts` | yes | [T-402](tasks/T-402-room-store.md) | [T-503](tasks/T-503-agent-toolbelt.md), [T-506](tasks/T-506-metered-budget-wiring.md) |
...
| `src/worker/toolbelt.ts` | not yet | [T-503](tasks/T-503-agent-toolbelt.md) | — |
...
| `tests/gateway-client.test.ts` | not yet | [T-303](tasks/T-303-client-integration.md) | — |
| `tests/materializer.test.ts` | yes | [T-201](tasks/T-201-materialization-engine.md) | — |
| `tests/rooms.test.ts` | yes | [T-402](tasks/T-402-room-store.md) | — |
