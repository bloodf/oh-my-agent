...
| `src/daemon/socket.ts` | yes | [T-502](tasks/T-502-daemon-entry-point.md) | [T-503](tasks/T-503-agent-toolbelt.md), [T-504](tasks/T-504-tui-surface.md) |
...
| `src/shared/protocol-schemas.ts` | yes | [T-507](tasks/T-507-control-socket-protocol.md) | — |
| `src/shared/protocol.ts` | yes | [T-507](tasks/T-507-control-socket-protocol.md) | [T-502](tasks/T-502-daemon-entry-point.md), [T-503](tasks/T-503-agent-toolbelt.md), [T-504](tasks/T-504-tui-surface.md) |
...
| `tests/daemon-main.test.ts` | yes | [T-502](tasks/T-502-daemon-entry-point.md) | — |
...
| `tests/protocol.contract.test.ts` | yes | [T-507](tasks/T-507-control-socket-protocol.md) | — |
